...
--model_dir=inception \
--learning_rate=0.99 \
--summaries_dir=training_summaries/1000stepsrate065test20 \
...
curl -O https://raw.githubusercontent.com/tensorflow/models/tutorials/image/imagenet/classify_image.py

python classify_image.py --model_dir home/ubuntu/tf_files/imagenet
